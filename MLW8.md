...
Thus, (7) is our new, rewritten wave function that is equal to the operator that is used to operate on the original wave function. If 
we want to delve into the minutiae of how this new wave function would look like in MatLab, we can do this simply by studying our equation (7).
